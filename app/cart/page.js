...
export default function CartPage() {
    ...
    return (
        ...
        <div className="max-w-7xl mx-auto p-4 md:p-10 grid grid-cols-1 lg:grid-cols-3 gap-10">
            ...
            <div className="lg:col-span-2 space-y-6">
                ...
                {cartItems.map((item) => (
                    <div
                        key={item.id}
                        className="flex flex-col sm:flex-row gap-6 bg-white shadow rounded-lg p-5"
                    >
                        ...
                        <div className="flex flex-row sm:flex-col justify-between items-center sm:items-end gap-3">
            ...
            <div className="bg-white shadow rounded-lg p-6 h-fit lg:sticky lg:top-24">
